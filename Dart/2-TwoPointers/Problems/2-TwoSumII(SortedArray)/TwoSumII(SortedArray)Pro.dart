void main() {
  List<int> prices = [100, 200, 350, 400, 500, 600];
  int budget = 750;
  ...
  if (result != null) {
    print("You can buy items at indices: \${result[0]} and \${result[1]} within your budget.");
  } else {
    ...
    if (closest != null) {
      print("Closest affordable items are at indices: \${closest[0]} and \${closest[1]} with total cost \${prices[closest[0]] + prices[closest[1]]}");
    } else {
